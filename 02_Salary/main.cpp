...
int main() {
	try {
		...
		//Employee tests
		Boss* b_bad = new Boss{ "","","","asdf",0 };	//no entries
		CommissionWorker* c_bad = new CommissionWorker{ "abc", "def", "x", "dasistke", 0 };	//bad insurance format
		
		comp2.AddEmployee(b_bad);
		comp2.AddEmployee(c_bad);
